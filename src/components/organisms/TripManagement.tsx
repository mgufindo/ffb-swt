        ...
        <div className="flex items-center">
          ...
          <div className="ml-4">
            <div className="text-sm font-medium text-gray-900">
              Trip #{row.id.slice(0, 8)}
            </div>
            <div className="text-sm text-gray-500">
              {row.vehicle.plateNumber} • {row.vehicle.type}
            </div>
          </div>
        </div>
      ),
      ...
      >
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M6 18L18 6M6 6l12 12M9 6h6m-3-3v3m-3 0h6m-6 0H9m0 0V3m3 0h3m-3 0H9m0 0H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2V9a2 2 0 00-2-2H9z"
          />
        </svg>
      </button>
    </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            Manage evacuation trips efficiently
          </p>
        </div>
      ...
      <ConfirmModal
        ...
        title="Delete Trip"
        message={`Are you sure you want to delete trip #${deleteConfirm.trip?.id.slice(
          0,
          8
